...
lm.compare <- lm(log(new_result_value) ~ MFR, data = s8data)
...
glme.equation <- tibble(x = s8data$MFR,y = exp(3.402511 + 2.075818*s8data$MFR))
lm.equation <- tibble(x = s8data$MFR,y = exp(2.93201 + 2.06656*s8data$MFR))
